...
class JeetPatel:
    def __init__(self):
        ...
        self.education = {
            "Master's": "Data Science @ Indiana University (GPA: 3.8/4.0)",
            "Bachelor's": "Electronics & Telecommunication Engineering @ DJ Sanghvi (GPA: 3.7/4.0)"
        }
        self.location = "Bloomington, IN"
        self.skills = ["Data Science", "Machine Learning", "MLOps", "Deep Learning", "NLP"]
        self.currently_exploring = ["LLMs", "Vector Databases", "RAG Systems", "Semantic Search"]
    
    def get_tech_stack(self):
        return {
            "languages": ["Python", "SQL", "Scala", "R"],
            "ml_frameworks": ["PyTorch", "TensorFlow", "Scikit-learn", "Hugging Face"],
            "data_tools": ["Spark", "Hadoop", "Pandas", "Delta Lake", "dbt"],
            "cloud": ["AWS", "Azure", "GCP"],
            "databases": ["PostgreSQL", "MongoDB", "Snowflake", "Redis", "Neo4j"],
            "visualization": ["Tableau", "Power BI", "Plotly", "Seaborn"]
        }
        
    def life_motto(self):
        return "Transform complex data into actionable insights that drive real-world impact"
```
